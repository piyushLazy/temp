        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="border rounded-lg p-6 shadow-sm md:w-80">
            ...
            <div className="w-24 h-20 mt-2">
                <Image src={first} alt="first" height={100} width={100} />
          ...
          <div className="border rounded-lg p-6 shadow-sm md:w-80">
            ...
            <div className="w-36 h-32">              <Image src={second} alt="first" height={100} width={100} />
              </div> {/* Placeholder for Icon */}
              <div>
          ...
          <div className="border rounded-lg p-6 shadow-sm md:w-80">
            ...
            <div className="w-24 h-20">              <Image src={third} alt="first" height={100} width={100} />
              </div> {/* Placeholder for Icon */}
              <div>
          ...
          <div className="border rounded-lg p-6 shadow-sm md:w-80">
            <div className="flex items-start space-x-4">
            <div className="w-24 h-20 mt-2">              <Image src={fourth} alt="first" height={100} width={100} />
              </div> {/* Placeholder for Icon */}
              <div>
